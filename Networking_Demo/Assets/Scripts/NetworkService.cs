...
public class NetworkService
{
    private const string xmlApi =
        "http://api.openweathermap.org/data/2.5/weather?q=Chicago,us&mode=xml&appid=dd9dd4e11811131d60a2b367b45fa46b";
    private const string jsonApi =
        "http://api.openweathermap.org/data/2.5/weather?q=Chicago,us&appid=dd9dd4e11811131d60a2b367b45fa46b";
    ...
    {
        using (UnityWebRequest request = (form == null) ? UnityWebRequest.Get(url)
